...
class AccountStatus(str, Enum):
    ...
    INVALID      = "invalid"
    # BUSINESS RT 长跑链路使用
    PENDING_INVITE      = "pending_invite"        # 新流程:已注册,等母号发邀请
    PENDING_ACTIVATE    = "pending_activate"      # 新流程:邀请已发,等激活成 user (进 workspace)
    PENDING_SEAT_CHANGE = "pending_seat_change"   # 新流程:已激活,等切 default 席位(独立 daemon)
    PENDING_RT          = "pending_rt"
    PENDING_SEAT_SWITCH = "pending_seat_switch"   # 旧 Codex 路径用,新流程不写
    READY_FOR_EXPORT    = "ready_for_export"
    RT_UNREACHABLE      = "rt_unreachable"
...
class RegisterConfig:
    """注册任务配置"""
    executor_type: str = "headless"   # protocol | headless | headed
